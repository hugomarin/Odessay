...
*(CONFIG-07 closed — see below. SHARE-04 moved from `NONE` to `PARTIAL_INTEGRATION` — real DB-substrate proof, service-role path still open — and removed from this list since it's no longer `NONE`/`UNIT_ONLY`; see the SHARE-04 row and the "Remaining P0 items" note below.)*
