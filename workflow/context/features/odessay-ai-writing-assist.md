...
- Si el provider falla al usar `response_format` estructurado (400/422 o 5xx), la route reintenta internamente una vez sin `response_format` antes de devolver fallo al cliente.
