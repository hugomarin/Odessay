...
- `workflow.md` puede ser redactado por el propio agente a partir del contexto existente del workspace; una vez que existe, cualquier acción recibe su descriptor y carga el cuerpo mediante evidencia bajo demanda cuando la intención lo requiere (ejecutar el workflow debe validar y leer lo necesario antes de proponer una mutación);
