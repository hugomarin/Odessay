...
-- revoke execute on function public.replace_writing_collections(uuid, uuid[], timestamptz) from authenticated;
-- drop function if exists public.replace_writing_collections(uuid, uuid[], timestamptz);
