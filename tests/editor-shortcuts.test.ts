...
describe("getEditorShortcutLabel", () => {
  it("formats labels for mac", () => {
    ...
    expect(getEditorShortcutLabel("shortcutHelp")).toBe("⌘/")
  ...
  it("formats labels for windows/linux", () => {
    ...
    expect(getEditorShortcutLabel("shortcutHelp")).toBe("Ctrl+/")
    expect(getEditorShortcutLabel("newWriting")).toBe("Ctrl+N")
