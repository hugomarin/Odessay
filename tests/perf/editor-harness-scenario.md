...
7. Expand replace with `Cmd/Ctrl+Alt+F`, replace all matches with `omega beta`, confirm the exact replacement count, execute a short deterministic editor click sequence, and wait for deferred editor side effects to settle.
