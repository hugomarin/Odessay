...
El setup completo de observabilidad está en `workflow/quality/testing-observability.md`. Resumen para el agente:
...
Fuente canónica de variables y matriz por entorno: `workflow/setup/environment.md §Variables de entorno`.
