---
name: skill-backend
description: Estándares backend de Odessay para API routes, lógica server-side, autenticación, Supabase server-side, integración con Claude API/Resend y manejo de errores. Usar cuando implementes o revises endpoints, flujos de auto-save/sync, validación de input y configuración de variables de entorno del servidor.
---
