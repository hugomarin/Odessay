...
Lee `docs/core/odessay-fundacional.md` para la visión epistolar y `docs/core/odessay-modelo-datos.md` para el schema de `correspondences` y `writings`.
...
Ver `docs/features/odessay-margenes.md` para la spec del sistema de highlights y anotaciones disponible en esta vista.

---

## Modelo de datos (referencia)

Schema completo en `docs/core/odessay-modelo-datos.md`. Las tablas relevantes:
...
- Sistema de márgenes (highlights y anotaciones) → `docs/features/odessay-margenes.md`
- Mecanismo de respuesta (`/write?reply_to`) → `docs/core/odessay-flujos.md` §Leer y Responder
- Schema completo de tablas → `docs/core/odessay-modelo-datos.md`
- Visibilidad compartida → `docs/core/odessay-paginas.md` §/shared
