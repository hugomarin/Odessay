...
**Tipo de documento:** `skill-design.md` + `skill-design-vistas.md` + carpeta `reference/`. El agente no interpreta — tiene los valores exactos.
...
/skills
  ...
  skill-design-vistas/ → pregunta 3
